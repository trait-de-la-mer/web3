...
public class HitResult implements Serializable {
    ...
    @Column(name = "ID", columnDefinition = "BIGINT GENERATED BY DEFAULT AS IDENTITY")  // Явное указание для H2
    private Long id;
    ...
    @Temporal(TemporalType.TIMESTAMP)  // Теперь работает с java.util.Date
    private Date createdAt;  // ИЗМЕНИТЬ: Date вместо Timestamp
    ...
    // Или если нужно использовать LocalDateTime:
